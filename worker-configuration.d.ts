/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 0b6aeb33328816222fc9b945bbd5eacb)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		DISPOSABLE_DOMAINS_NAMESPACE_ID: string
		VPN_IPS_NAMESPACE_ID: string
		TOR_IPS_NAMESPACE_ID: string
		SUPABASE_URL: string
		SUPABASE_KEY: string
