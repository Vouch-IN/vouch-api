/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 243ee2bd6b3d8d6c53a4ca1f1c2cc9a1)
// Runtime types generated with workerd@1.20251008.0 2025-10-08
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import('./worker/index')
		durableNamespaces: 'FingerprintStore' | 'LogQueue' | 'UsageCounter'
	}
	interface Env {
		...
		FINGERPRINTS: DurableObjectNamespace<import('./worker/index').FingerprintStore>
		LOG_QUEUE: DurableObjectNamespace<import('./worker/index').LogQueue>
		USAGE_COUNTER: DurableObjectNamespace<import('./worker/index').UsageCounter>
	}
}
