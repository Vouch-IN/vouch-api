-- ============================================================================
-- FORCE REFRESH VALIDATION_LOGS_DAILY MATERIALIZED VIEW
-- This migration ensures the materialized view is rebuilt with fresh data
-- ============================================================================

-- Drop and recreate to ensure fresh data (fixes any stale cache issues)
DROP MATERIALIZED VIEW IF EXISTS validation_logs_daily CASCADE;
...
-- Recreate the get_validation_logs_daily function
...
-- Recreate the get_all_validation_logs_daily function
